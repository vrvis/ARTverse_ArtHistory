...
You can visit the VRChat World here: https://vrchat.com/home/launch?worldId=wrld_a1686156-3fc2-4512-abed-482477c933bb

Use the VRChat CreatorCompanion App to install the Unity Version, the VRChat SDK and open the project. 
Unity Version - 2022.3.22f1
VRChat SDK - 3.6.1

The assets, prefabs and scripts developed for the ARTverse projects are in the "TheaterScene" scene. 
